...
(* resumes replay from a committed offset `cur <= hw` (offset-lags-state).    *)
...
\* the offset the owner presents for its tick delete: the replay fix raises cur to the high-water
